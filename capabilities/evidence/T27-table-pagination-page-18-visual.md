...
- Expected-raster authority: [`../expected/T27-table-pagination-page-18-144dpi-srgb.png`](../expected/T27-table-pagination-page-18-144dpi-srgb.png)
...
- Raster artifact: [`artifacts/T27-table-pagination-page-18-expected.png`](artifacts/T27-table-pagination-page-18-expected.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-18-pdfium.png`](artifacts/T27-table-pagination-page-18-pdfium.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-18-implementation.png`](artifacts/T27-table-pagination-page-18-implementation.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-18-difference.png`](artifacts/T27-table-pagination-page-18-difference.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-18-renderer-difference.png`](artifacts/T27-table-pagination-page-18-renderer-difference.png)
- Raw findings: [`artifacts/T27-table-pagination-page-18-visual.txt`](artifacts/T27-table-pagination-page-18-visual.txt)
