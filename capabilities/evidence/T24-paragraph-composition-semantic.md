...
Producer: `folio-pdf-t24-semantic-assertions`
...
The oracle is a hand-calculated table, not a call to the layout implementation. All observations use public queries after reopening the published artifact.

[Detailed observations](artifacts/T24-paragraph-composition-semantic.txt)
