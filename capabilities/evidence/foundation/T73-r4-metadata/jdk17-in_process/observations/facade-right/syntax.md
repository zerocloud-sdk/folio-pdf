...
Input exact SHA-256: `7aacebad03c7edd38067efdeddee54473b8321aba9fa1aabe9e354338f30facb`
...
- Product: [`metadata.pdf`](metadata.pdf)
- qpdf findings: [`syntax.txt`](syntax.txt)
- qpdf completed `--check` for the T73 product with exit code `0`.
