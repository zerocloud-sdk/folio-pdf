...
Producer: `qpdf-and-fontTools`

Producer version: `12.4.0/4.59.2`
...
Subset verifier source SHA-256: `fdc08212cbc2efba9166b71100cd3841b5700e09f0a90329992154a57d346888`


The independent verifier follows the painted CIDToGID mapping, compares outlines and transitive composite dependencies with pinned source fonts, and checks the ToUnicode logical input clusters.

- [IN_PROCESS](artifacts/T29-shaping-subsets.txt)
- [HARDENED_WORKER](artifacts/T29-shaping-worker-subsets.txt)
