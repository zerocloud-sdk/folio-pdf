...
Left, right and first-line indentation across two columns and a page boundary.

Zero insets are neutral. A negative first-line offset is admitted only inside the area. An inset leaving no positive line width makes the area unusable; exhausting all areas fails.
...
render configuration are recorded in the [page 1 profile](../profiles/T25-paragraph-indentation-page-1-visual.properties)
and [page 2 profile](../profiles/T25-paragraph-indentation-page-2-visual.properties).

## Public behavior and evidence

The public `DocumentWorkflow.execute` tests run in both execution profiles:
`indentsAndWidthCapContinueAcrossColumnsAndPages; hangingFirstLineDoesNotRepeatOnTheNextPage` in
...
- [Syntax evidence](T25-paragraph-indentation-syntax.md)
- [Semantic/structure evidence](T25-paragraph-indentation-semantic.md)
- [Both visual comparisons](T25-paragraph-indentation-visual.md)
- [Published product](artifacts/T25-paragraph-indentation.pdf)
