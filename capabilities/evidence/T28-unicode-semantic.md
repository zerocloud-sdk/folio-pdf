# T28 independent Unicode semantic and geometric evidence
...
Producer: `folio-pdf-t28-semantic-assertions`
...
All seven profiles compare every scalar's display order, original glyph ID, baseline, advance, text matrix, page box and explicit embedded subset names after public Workflow reopen. The expected rows come from manual lines and pinned source-font metrics, without ICU or Folio layout.

[All seven profile observations](artifacts/T28-unicode-semantic.txt)
