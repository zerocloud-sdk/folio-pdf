...
- Expected-raster authority: [`../expected/T27-table-pagination-page-4-144dpi-srgb.png`](../expected/T27-table-pagination-page-4-144dpi-srgb.png)
...
- Raster artifact: [`artifacts/T27-table-pagination-page-4-expected.png`](artifacts/T27-table-pagination-page-4-expected.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-4-pdfium.png`](artifacts/T27-table-pagination-page-4-pdfium.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-4-implementation.png`](artifacts/T27-table-pagination-page-4-implementation.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-4-difference.png`](artifacts/T27-table-pagination-page-4-difference.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-4-renderer-difference.png`](artifacts/T27-table-pagination-page-4-renderer-difference.png)
- Raw findings: [`artifacts/T27-table-pagination-page-4-visual.txt`](artifacts/T27-table-pagination-page-4-visual.txt)
