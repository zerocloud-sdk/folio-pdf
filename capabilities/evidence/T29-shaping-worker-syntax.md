...
- Product: [`artifacts/T29-shaping-worker.pdf`](artifacts/T29-shaping-worker.pdf)
- qpdf findings: [`artifacts/T29-shaping-worker-qpdf.txt`](artifacts/T29-shaping-worker-qpdf.txt)
