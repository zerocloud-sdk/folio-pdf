...
- Raster artifact: [`artifacts/T29-shaping-thai-page-2-expected.png`](artifacts/T29-shaping-thai-page-2-expected.png)
- Raster artifact: [`artifacts/T29-shaping-thai-page-2-pdfium.png`](artifacts/T29-shaping-thai-page-2-pdfium.png)
- Raster artifact: [`artifacts/T29-shaping-thai-page-2-implementation.png`](artifacts/T29-shaping-thai-page-2-implementation.png)
- Raster artifact: [`artifacts/T29-shaping-thai-page-2-difference.png`](artifacts/T29-shaping-thai-page-2-difference.png)
- Raster artifact: [`artifacts/T29-shaping-thai-page-2-renderer-difference.png`](artifacts/T29-shaping-thai-page-2-renderer-difference.png)
- Raw findings: [`artifacts/T29-shaping-thai-page-2-visual.txt`](artifacts/T29-shaping-thai-page-2-visual.txt)
