...
- Expected-raster authority: [`../expected/T27-table-pagination-page-13-144dpi-srgb.png`](../expected/T27-table-pagination-page-13-144dpi-srgb.png)
...
- Raster artifact: [`artifacts/T27-table-pagination-page-13-expected.png`](artifacts/T27-table-pagination-page-13-expected.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-13-pdfium.png`](artifacts/T27-table-pagination-page-13-pdfium.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-13-implementation.png`](artifacts/T27-table-pagination-page-13-implementation.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-13-difference.png`](artifacts/T27-table-pagination-page-13-difference.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-13-renderer-difference.png`](artifacts/T27-table-pagination-page-13-renderer-difference.png)
- Raw findings: [`artifacts/T27-table-pagination-page-13-visual.txt`](artifacts/T27-table-pagination-page-13-visual.txt)
