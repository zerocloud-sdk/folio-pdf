...
- Expected-raster authority: [`../expected/T27-table-pagination-page-19-144dpi-srgb.png`](../expected/T27-table-pagination-page-19-144dpi-srgb.png)
...
- Raster artifact: [`artifacts/T27-table-pagination-page-19-expected.png`](artifacts/T27-table-pagination-page-19-expected.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-19-pdfium.png`](artifacts/T27-table-pagination-page-19-pdfium.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-19-implementation.png`](artifacts/T27-table-pagination-page-19-implementation.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-19-difference.png`](artifacts/T27-table-pagination-page-19-difference.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-19-renderer-difference.png`](artifacts/T27-table-pagination-page-19-renderer-difference.png)
- Raw findings: [`artifacts/T27-table-pagination-page-19-visual.txt`](artifacts/T27-table-pagination-page-19-visual.txt)
