...
Producer: `folio-pdf-t29-semantic-assertions`
...
Every painted item is compared after public Workflow reopening: logical cluster mapping, matrix, baseline, advance, page box, exact item count and explicit embedded subset names. Aggregate ActualText is compared with the fixed logical runs.
