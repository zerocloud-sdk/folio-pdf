...
- Expected-raster authority: [`../expected/T27-table-pagination-page-9-144dpi-srgb.png`](../expected/T27-table-pagination-page-9-144dpi-srgb.png)
...
- Raster artifact: [`artifacts/T27-table-pagination-page-9-expected.png`](artifacts/T27-table-pagination-page-9-expected.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-9-pdfium.png`](artifacts/T27-table-pagination-page-9-pdfium.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-9-implementation.png`](artifacts/T27-table-pagination-page-9-implementation.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-9-difference.png`](artifacts/T27-table-pagination-page-9-difference.png)
- Raster artifact: [`artifacts/T27-table-pagination-page-9-renderer-difference.png`](artifacts/T27-table-pagination-page-9-renderer-difference.png)
- Raw findings: [`artifacts/T27-table-pagination-page-9-visual.txt`](artifacts/T27-table-pagination-page-9-visual.txt)
