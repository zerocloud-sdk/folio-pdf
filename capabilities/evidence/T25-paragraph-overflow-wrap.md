...
Scalar fallback wraps twelve As into three two-character lines on each page.

Default WRAP preserves spaces and scalar text. Graphics and tab fields stay atomic. Vertical overflow advances through finite declared areas; exhaustion fails COMPOSITION_AREA_EXHAUSTED and preserves publication targets.
...
render configuration are recorded in the [page 1 profile](../profiles/T25-paragraph-overflow-wrap-page-1-visual.properties)
and [page 2 profile](../profiles/T25-paragraph-overflow-wrap-page-2-visual.properties).

## Public behavior and evidence

The public `DocumentWorkflow.execute` tests run in both execution profiles:
`wrapAndVisibleOverflowPreserveEveryCharacterAcrossPages; rejectOverflowUsesAWiderPageAndExhaustionNeverTruncates` in
...
- [Syntax evidence](T25-paragraph-overflow-wrap-syntax.md)
- [Semantic/structure evidence](T25-paragraph-overflow-wrap-semantic.md)
- [Both visual comparisons](T25-paragraph-overflow-wrap-visual.md)
- [Published product](artifacts/T25-paragraph-overflow-wrap.pdf)
