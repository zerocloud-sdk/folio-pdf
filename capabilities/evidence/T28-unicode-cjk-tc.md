...
Page 5 of the shared seven-page product uses the [fixed manual corpus](../profiles/T28-unicode-reference.md)
...
The [independent visual record](T28-unicode-cjk-tc-visual.md) passes at the original
144-DPI opaque-white sRGB profile: zero-fuzz primary AE and changed pixels
are both zero; secondary changed pixels are 4092, below 12000.
