...
Immediate flush rejects relayout while preserving the original two-page result.

IMMEDIATE drops the retained declaration/prepared selection after successful composition. Explicit flush is idempotent; later successful mutations also seal the flow. Relayout fails COMPOSITION_RELAYOUT_UNSAFE; neither kind of flush publishes early.
...
render configuration are recorded in the [page 1 profile](../profiles/T25-paragraph-immediate-flush-page-1-visual.properties)
and [page 2 profile](../profiles/T25-paragraph-immediate-flush-page-2-visual.properties).

## Public behavior and evidence

The public `DocumentWorkflow.execute` tests run in both execution profiles:
`immediateAndExplicitFlushSealTheFlowWithoutEarlyPublication; laterMutationSealsRelayoutAndNewCompositionEstablishesANewBuffer` in
...
- [Syntax evidence](T25-paragraph-immediate-flush-syntax.md)
- [Semantic/structure evidence](T25-paragraph-immediate-flush-semantic.md)
- [Both visual comparisons](T25-paragraph-immediate-flush-visual.md)
- [Published product](artifacts/T25-paragraph-immediate-flush.pdf)
- [Independent reference](artifacts/T25-paragraph-immediate-flush-reference.pdf)
