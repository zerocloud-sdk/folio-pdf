...
- Expected-raster authority: [`../expected/T25-paragraph-publication-page-1-144dpi-srgb.png`](../expected/T25-paragraph-publication-page-1-144dpi-srgb.png)
...
- Raster artifact: [`artifacts/T25-paragraph-publication-page-1-expected.png`](artifacts/T25-paragraph-publication-page-1-expected.png)
- Raster artifact: [`artifacts/T25-paragraph-publication-page-1-pdfium.png`](artifacts/T25-paragraph-publication-page-1-pdfium.png)
- Raster artifact: [`artifacts/T25-paragraph-publication-page-1-implementation.png`](artifacts/T25-paragraph-publication-page-1-implementation.png)
- Raster artifact: [`artifacts/T25-paragraph-publication-page-1-difference.png`](artifacts/T25-paragraph-publication-page-1-difference.png)
- Raster artifact: [`artifacts/T25-paragraph-publication-page-1-renderer-difference.png`](artifacts/T25-paragraph-publication-page-1-renderer-difference.png)
- Raw findings: [`artifacts/T25-paragraph-publication-page-1-visual.txt`](artifacts/T25-paragraph-publication-page-1-visual.txt)
