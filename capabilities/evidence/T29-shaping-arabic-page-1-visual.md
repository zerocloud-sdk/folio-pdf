...
- Raster artifact: [`artifacts/T29-shaping-arabic-page-1-expected.png`](artifacts/T29-shaping-arabic-page-1-expected.png)
- Raster artifact: [`artifacts/T29-shaping-arabic-page-1-pdfium.png`](artifacts/T29-shaping-arabic-page-1-pdfium.png)
- Raster artifact: [`artifacts/T29-shaping-arabic-page-1-implementation.png`](artifacts/T29-shaping-arabic-page-1-implementation.png)
- Raster artifact: [`artifacts/T29-shaping-arabic-page-1-difference.png`](artifacts/T29-shaping-arabic-page-1-difference.png)
- Raster artifact: [`artifacts/T29-shaping-arabic-page-1-renderer-difference.png`](artifacts/T29-shaping-arabic-page-1-renderer-difference.png)
- Raw findings: [`artifacts/T29-shaping-arabic-page-1-visual.txt`](artifacts/T29-shaping-arabic-page-1-visual.txt)
