...
- Expected-raster authority: [`../expected/T25-paragraph-overflow-visible-page-2-144dpi-srgb.png`](../expected/T25-paragraph-overflow-visible-page-2-144dpi-srgb.png)
...
- Raster artifact: [`artifacts/T25-paragraph-overflow-visible-page-2-expected.png`](artifacts/T25-paragraph-overflow-visible-page-2-expected.png)
- Raster artifact: [`artifacts/T25-paragraph-overflow-visible-page-2-pdfium.png`](artifacts/T25-paragraph-overflow-visible-page-2-pdfium.png)
- Raster artifact: [`artifacts/T25-paragraph-overflow-visible-page-2-implementation.png`](artifacts/T25-paragraph-overflow-visible-page-2-implementation.png)
- Raster artifact: [`artifacts/T25-paragraph-overflow-visible-page-2-difference.png`](artifacts/T25-paragraph-overflow-visible-page-2-difference.png)
- Raster artifact: [`artifacts/T25-paragraph-overflow-visible-page-2-renderer-difference.png`](artifacts/T25-paragraph-overflow-visible-page-2-renderer-difference.png)
- Raw findings: [`artifacts/T25-paragraph-overflow-visible-page-2-visual.txt`](artifacts/T25-paragraph-overflow-visible-page-2-visual.txt)
