...
- Product: [`artifacts/T30-one-dimensional-barcodes-hardened-worker.pdf`](artifacts/T30-one-dimensional-barcodes-hardened-worker.pdf)
- qpdf findings: [`artifacts/T30-one-dimensional-barcodes-hardened-worker-qpdf.txt`](artifacts/T30-one-dimensional-barcodes-hardened-worker-qpdf.txt)
