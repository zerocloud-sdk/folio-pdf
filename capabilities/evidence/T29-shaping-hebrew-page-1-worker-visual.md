...
- Raster artifact: [`artifacts/T29-shaping-hebrew-page-1-worker-expected.png`](artifacts/T29-shaping-hebrew-page-1-worker-expected.png)
- Raster artifact: [`artifacts/T29-shaping-hebrew-page-1-worker-pdfium.png`](artifacts/T29-shaping-hebrew-page-1-worker-pdfium.png)
- Raster artifact: [`artifacts/T29-shaping-hebrew-page-1-worker-implementation.png`](artifacts/T29-shaping-hebrew-page-1-worker-implementation.png)
- Raster artifact: [`artifacts/T29-shaping-hebrew-page-1-worker-difference.png`](artifacts/T29-shaping-hebrew-page-1-worker-difference.png)
- Raster artifact: [`artifacts/T29-shaping-hebrew-page-1-worker-renderer-difference.png`](artifacts/T29-shaping-hebrew-page-1-worker-renderer-difference.png)
- Raw findings: [`artifacts/T29-shaping-hebrew-page-1-worker-visual.txt`](artifacts/T29-shaping-hebrew-page-1-worker-visual.txt)
