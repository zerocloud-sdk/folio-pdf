 ...
 */
public final class T31CharsetProvider extends CharsetProvider {
    ...
    private static final class MappingCharset extends Charset {
        ...
        MappingCharset(int part) {
            ...
            String resource = "/net/zerocloud/pdf/acceptance/barcode-charset/8859-" + part + ".TXT";
            try (InputStream input = T31CharsetProvider.class.getResourceAsStream(resource);
