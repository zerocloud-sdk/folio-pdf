...
| [`document.annotations-actions.manage`](#capability-document_dot_annotations_dash_actions_dot_manage) | `document-engine` | `compatible` | [`itext7.kernel.pdf-catalog.get-open-action`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_catalog_dot_get_dash_open_dash_action), [`itext7.kernel.pdf-catalog.set-open-action`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_catalog_dot_set_dash_open_dash_action), [`itext7.kernel.pdf-document.flatten-annotations`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_flatten_dash_annotations), [`itext7.kernel.pdf-document.get-actions`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_actions), [`itext7.kernel.pdf-document.get-annotations`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_annotations), [`itext7.kernel.pdf-document.update-annotations`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_update_dash_annotations), [`itext7.kernel.pdf-page.add-annotation`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_page_dot_add_dash_annotation), [`itext7.kernel.pdf-page.get-additional-actions`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_page_dot_get_dash_additional_dash_actions), [`itext7.kernel.pdf-page.get-annotations`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_page_dot_get_dash_annotations), [`itext7.kernel.pdf-page.remove-annotation`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_page_dot_remove_dash_annotation), [`itext7.kernel.pdf-page.set-additional-action`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_page_dot_set_dash_additional_dash_action), [`itext7.kernel.pdf-page.set-normal-appearance`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_page_dot_set_dash_normal_dash_appearance) |
| [`document.blank.create-publish-reopen`](#capability-document_dot_blank_dot_create_dash_publish_dash_reopen) | `document-engine` | `compatible` | [`itext7.kernel.pdf-document.add-new-page`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_add_dash_new_dash_page), [`itext7.kernel.pdf-document.close`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_close), [`itext7.kernel.pdf-document.constructor-reader`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_constructor_dash_reader), [`itext7.kernel.pdf-document.constructor-writer`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_constructor_dash_writer), [`itext7.kernel.pdf-document.get-number-of-pages`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_number_dash_of_dash_pages), [`itext7.kernel.pdf-exception.constructor-message-cause`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_exception_dot_constructor_dash_message_dash_cause), [`itext7.kernel.pdf-page.get-pdf-object`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_page_dot_get_dash_pdf_dash_object), [`itext7.kernel.pdf-reader.close`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_reader_dot_close), [`itext7.kernel.pdf-reader.constructor-string`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_reader_dot_constructor_dash_string), [`itext7.kernel.pdf-writer.constructor-string`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_writer_dot_constructor_dash_string), [`itext7.layout.document.close`](facade-surface.md#facade-surface-itext7_dot_layout_dot_document_dot_close), [`itext7.layout.document.constructor-pdf-document`](facade-surface.md#facade-surface-itext7_dot_layout_dot_document_dot_constructor_dash_pdf_dash_document) |
...
| [`document.metadata.outlines-destinations-attachments`](#capability-document_dot_metadata_dot_outlines_dash_destinations_dash_attachments) | `document-engine` | `compatible` | [`itext7.kernel.pdf-document-info.add-creation-date`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_add_dash_creation_dash_date), [`itext7.kernel.pdf-document-info.add-mod-date`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_add_dash_mod_dash_date), [`itext7.kernel.pdf-document-info.get-author`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_get_dash_author), [`itext7.kernel.pdf-document-info.get-creator`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_get_dash_creator), [`itext7.kernel.pdf-document-info.get-entries`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_get_dash_entries), [`itext7.kernel.pdf-document-info.get-keywords`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_get_dash_keywords), [`itext7.kernel.pdf-document-info.get-more-info`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_get_dash_more_dash_info), [`itext7.kernel.pdf-document-info.get-producer`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_get_dash_producer), [`itext7.kernel.pdf-document-info.get-subject`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_get_dash_subject), [`itext7.kernel.pdf-document-info.get-title`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_get_dash_title), [`itext7.kernel.pdf-document-info.get-trapped`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_get_dash_trapped), [`itext7.kernel.pdf-document-info.set-author`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_set_dash_author), [`itext7.kernel.pdf-document-info.set-creator`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_set_dash_creator), [`itext7.kernel.pdf-document-info.set-keywords`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_set_dash_keywords), [`itext7.kernel.pdf-document-info.set-more-info-map`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_set_dash_more_dash_info_dash_map), [`itext7.kernel.pdf-document-info.set-more-info`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_set_dash_more_dash_info), [`itext7.kernel.pdf-document-info.set-producer`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_set_dash_producer), [`itext7.kernel.pdf-document-info.set-subject`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_set_dash_subject), [`itext7.kernel.pdf-document-info.set-title`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_set_dash_title), [`itext7.kernel.pdf-document-info.set-trapped`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_set_dash_trapped), [`itext7.kernel.pdf-document-info.update-entries`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_update_dash_entries), [`itext7.kernel.pdf-document.add-file-attachment`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_add_dash_file_dash_attachment), [`itext7.kernel.pdf-document.add-named-destination`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_add_dash_named_dash_destination), [`itext7.kernel.pdf-document.constructor-named-sources-targets-version`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_constructor_dash_named_dash_sources_dash_targets_dash_version), [`itext7.kernel.pdf-document.get-document-info`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_document_dash_info), [`itext7.kernel.pdf-document.get-file-attachment`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_file_dash_attachment), [`itext7.kernel.pdf-document.get-file-attachments`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_file_dash_attachments), [`itext7.kernel.pdf-document.get-named-destinations`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_named_dash_destinations), [`itext7.kernel.pdf-document.get-outlines`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_outlines), [`itext7.kernel.pdf-document.get-xmp-metadata-bounded`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_xmp_dash_metadata_dash_bounded), [`itext7.kernel.pdf-document.get-xmp-metadata`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_xmp_dash_metadata), [`itext7.kernel.pdf-document.set-named-destinations`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_set_dash_named_dash_destinations), [`itext7.kernel.pdf-document.set-outlines`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_set_dash_outlines), [`itext7.kernel.pdf-document.set-xmp-metadata`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_set_dash_xmp_dash_metadata) |
| [`document.page.manipulate-merge-split`](#capability-document_dot_page_dot_manipulate_dash_merge_dash_split) | `document-engine` | `compatible` | [`itext7.kernel.pdf-document.add-new-page-at-index`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_add_dash_new_dash_page_dash_at_dash_index), [`itext7.kernel.pdf-document.constructor-named-sources-targets`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_constructor_dash_named_dash_sources_dash_targets), [`itext7.kernel.pdf-document.copy-pages`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_copy_dash_pages), [`itext7.kernel.pdf-document.get-merger`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_merger), [`itext7.kernel.pdf-document.get-page`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_page), [`itext7.kernel.pdf-document.get-publication-receipts`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_publication_dash_receipts), [`itext7.kernel.pdf-document.get-splitter`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_splitter), [`itext7.kernel.pdf-document.move-page`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_move_dash_page), [`itext7.kernel.pdf-document.move-pages`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_move_dash_pages), [`itext7.kernel.pdf-document.remove-page`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_remove_dash_page), [`itext7.kernel.pdf-document.remove-pages`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_remove_dash_pages), [`itext7.kernel.pdf-page.get-pdf-object`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_page_dot_get_dash_pdf_dash_object), [`itext7.kernel.utils.pdf-merger.close`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_utils_dot_pdf_dash_merger_dot_close), [`itext7.kernel.utils.pdf-merger.constructor-document`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_utils_dot_pdf_dash_merger_dot_constructor_dash_document), [`itext7.kernel.utils.pdf-merger.merge-named-sources`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_utils_dot_pdf_dash_merger_dot_merge_dash_named_dash_sources), [`itext7.kernel.utils.pdf-splitter.constructor-document`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_utils_dot_pdf_dash_splitter_dot_constructor_dash_document), [`itext7.kernel.utils.pdf-splitter.extract-page-ranges`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_utils_dot_pdf_dash_splitter_dot_extract_dash_page_dash_ranges) |
...
| [`document.value.inspect-patch`](#capability-document_dot_value_dot_inspect_dash_patch) | `document-engine` | `compatible` | [`itext7.kernel.pdf-array.add-at-index`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_add_dash_at_dash_index), [`itext7.kernel.pdf-array.add`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_add), [`itext7.kernel.pdf-array.constructor-list`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_constructor_dash_list), [`itext7.kernel.pdf-array.constructor`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_constructor), [`itext7.kernel.pdf-array.get-as-direct`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_get_dash_as_dash_direct), [`itext7.kernel.pdf-array.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_get_dash_type), [`itext7.kernel.pdf-array.get`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_get), [`itext7.kernel.pdf-array.remove`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_remove), [`itext7.kernel.pdf-array.set`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_set), [`itext7.kernel.pdf-array.size`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_size), [`itext7.kernel.pdf-boolean.constant-false`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_boolean_dot_constant_dash_false), [`itext7.kernel.pdf-boolean.constant-true`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_boolean_dot_constant_dash_true), [`itext7.kernel.pdf-boolean.constructor-boolean`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_boolean_dot_constructor_dash_boolean), [`itext7.kernel.pdf-boolean.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_boolean_dot_get_dash_type), [`itext7.kernel.pdf-boolean.get-value`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_boolean_dot_get_dash_value), [`itext7.kernel.pdf-catalog.get-pdf-object`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_catalog_dot_get_dash_pdf_dash_object), [`itext7.kernel.pdf-dictionary.constructor`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_dictionary_dot_constructor), [`itext7.kernel.pdf-dictionary.contains-key`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_dictionary_dot_contains_dash_key), [`itext7.kernel.pdf-dictionary.get-as-direct`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_dictionary_dot_get_dash_as_dash_direct), [`itext7.kernel.pdf-dictionary.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_dictionary_dot_get_dash_type), [`itext7.kernel.pdf-dictionary.get`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_dictionary_dot_get), [`itext7.kernel.pdf-dictionary.key-set`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_dictionary_dot_key_dash_set), [`itext7.kernel.pdf-dictionary.put`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_dictionary_dot_put), [`itext7.kernel.pdf-dictionary.remove`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_dictionary_dot_remove), [`itext7.kernel.pdf-dictionary.size`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_dictionary_dot_size), [`itext7.kernel.pdf-document.constructor-reader-writer`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_constructor_dash_reader_dash_writer), [`itext7.kernel.pdf-document.get-catalog`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_catalog), [`itext7.kernel.pdf-indirect-reference.equals`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_indirect_dash_reference_dot_equals), [`itext7.kernel.pdf-indirect-reference.get-refers-to`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_indirect_dash_reference_dot_get_dash_refers_dash_to), [`itext7.kernel.pdf-indirect-reference.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_indirect_dash_reference_dot_get_dash_type), [`itext7.kernel.pdf-indirect-reference.hash-code`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_indirect_dash_reference_dot_hash_dash_code), [`itext7.kernel.pdf-name.constructor-string`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_name_dot_constructor_dash_string), [`itext7.kernel.pdf-name.equals`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_name_dot_equals), [`itext7.kernel.pdf-name.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_name_dot_get_dash_type), [`itext7.kernel.pdf-name.get-value`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_name_dot_get_dash_value), [`itext7.kernel.pdf-name.hash-code`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_name_dot_hash_dash_code), [`itext7.kernel.pdf-null.constant-pdf-null`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_null_dot_constant_dash_pdf_dash_null), [`itext7.kernel.pdf-null.constructor`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_null_dot_constructor), [`itext7.kernel.pdf-null.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_null_dot_get_dash_type), [`itext7.kernel.pdf-number.constructor-double`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_number_dot_constructor_dash_double), [`itext7.kernel.pdf-number.constructor-int`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_number_dot_constructor_dash_int), [`itext7.kernel.pdf-number.double-value`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_number_dot_double_dash_value), [`itext7.kernel.pdf-number.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_number_dot_get_dash_type), [`itext7.kernel.pdf-number.int-value`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_number_dot_int_dash_value), [`itext7.kernel.pdf-number.set-value-double`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_number_dot_set_dash_value_dash_double), [`itext7.kernel.pdf-number.set-value-int`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_number_dot_set_dash_value_dash_int), [`itext7.kernel.pdf-object.constant-array`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_constant_dash_array), [`itext7.kernel.pdf-object.constant-boolean`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_constant_dash_boolean), [`itext7.kernel.pdf-object.constant-dictionary`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_constant_dash_dictionary), [`itext7.kernel.pdf-object.constant-indirect-reference`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_constant_dash_indirect_dash_reference), [`itext7.kernel.pdf-object.constant-name`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_constant_dash_name), [`itext7.kernel.pdf-object.constant-null`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_constant_dash_null), [`itext7.kernel.pdf-object.constant-number`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_constant_dash_number), [`itext7.kernel.pdf-object.constant-stream`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_constant_dash_stream), [`itext7.kernel.pdf-object.constant-string`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_constant_dash_string), [`itext7.kernel.pdf-object.get-indirect-reference`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_get_dash_indirect_dash_reference), [`itext7.kernel.pdf-object.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_get_dash_type), [`itext7.kernel.pdf-object.is-array`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_is_dash_array), [`itext7.kernel.pdf-object.is-boolean`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_is_dash_boolean), [`itext7.kernel.pdf-object.is-dictionary`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_is_dash_dictionary), [`itext7.kernel.pdf-object.is-indirect-reference`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_is_dash_indirect_dash_reference), [`itext7.kernel.pdf-object.is-name`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_is_dash_name), [`itext7.kernel.pdf-object.is-null`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_is_dash_null), [`itext7.kernel.pdf-object.is-number`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_is_dash_number), [`itext7.kernel.pdf-object.is-stream`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_is_dash_stream), [`itext7.kernel.pdf-object.is-string`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_is_dash_string), [`itext7.kernel.pdf-reader.constructor-input-stream`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_reader_dot_constructor_dash_input_dash_stream), [`itext7.kernel.pdf-stream.constructor-bytes`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_stream_dot_constructor_dash_bytes), [`itext7.kernel.pdf-stream.get-bytes`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_stream_dot_get_dash_bytes), [`itext7.kernel.pdf-stream.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_stream_dot_get_dash_type), [`itext7.kernel.pdf-stream.set-data`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_stream_dot_set_dash_data), [`itext7.kernel.pdf-string.constructor-bytes`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_string_dot_constructor_dash_bytes), [`itext7.kernel.pdf-string.constructor-string`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_string_dot_constructor_dash_string), [`itext7.kernel.pdf-string.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_string_dot_get_dash_type), [`itext7.kernel.pdf-string.get-value-bytes`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_string_dot_get_dash_value_dash_bytes), [`itext7.kernel.pdf-string.get-value`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_string_dot_get_dash_value), [`itext7.kernel.pdf-writer.constructor-output-stream`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_writer_dot_constructor_dash_output_dash_stream) |
...
- Limitation: Image embedding remains T18; T20's cooperative transaction-wide policy applies, T21 can transport the same command through its opt-in Hardened Worker, and rendering remains T23. Layout, barcodes, Forms, tagged-document construction, SVG conversion, and redaction are not included.
...
- Context: `composition`
- Status: `experimental`
- Reference Suite source: `Issues 25 and 29 under parent issue 1; Unicode 16 UAX 9, 14, 24 and 29; existing project PDF and explicit-font contracts`
...
- Limitation: Indentation, tabs, keeps, widow/orphan, advanced overflow and tables retain their later command versions. T28 changes Unicode processing inside all existing paragraph/table versions without a source or binary interface break; line/page counts and generated byte counts may change. Direct positioned text remains scalar-order. No public backend SPI, module cycle, placeholder artifact or Migration Facade stub is added.

### Evidence

Implementation evidence:

- `public-unicode-workflow-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/consumer/UnicodeCompositionWorkflowTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/consumer/UnicodeCompositionWorkflowTest.java) — Both modes observe published/reopened graphemes, line and word/script boundaries, bidi numbers and mirrored punctuation, control omission, explicit four-region Noto selection, table cluster minima, stable failures and resource limits.
- `unicode-reference-declaration`: [`capabilities/profiles/T28-unicode-reference.md`](../../capabilities/profiles/T28-unicode-reference.md) — Manual seven-profile inputs and line/direction expectations, pinned fonts and fixed geometry/visual thresholds precede the implementation comparisons.
- `independent-unicode-reference-writer`: [`scripts/t28-unicode-reference.py`](../../scripts/t28-unicode-reference.py) — Pinned fontTools metrics and manually declared display lines generate a raw PDF and glyph oracle without ICU or Folio layout.
- `unicode-acceptance-negative-contract`: [`pdf-acceptance/src/test/java/net/zerocloud/pdf/acceptance/T28UnicodeEvidenceCommandTest.java`](../../pdf-acceptance/src/test/java/net/zerocloud/pdf/acceptance/T28UnicodeEvidenceCommandTest.java) — Seven profiles match the independent geometry in both modes; altered clusters, bidi order, regional programs and one-point geometry fail; unavailable tools remain indeterminate.
- `unicode-acceptance-record`: [`capabilities/evidence/T28-unicode.md`](../../capabilities/evidence/T28-unicode.md) — Retains all seven semantic, geometric and pinned PDFium/ImageMagick profiles, qpdf syntax, reference/font hashes, scope and remaining compatibility gates.
- `unicode-authoritative-contract`: [`docs/unicode-composition.md`](../unicode-composition.md) — Documents segmentation and bidi separately from shaping, logical versus painted text order, explicit font regions, limits, Worker admission and behavior migration.
...
- Limitation: WRAP permits complete-grapheme fallback between Unicode line opportunities; REJECT moves intact units between line opportunities to fitting areas; VISIBLE preserves complete overlong units beyond horizontal bounds. Graphics and tab fields never split. Vertical overflow always consumes finite declared areas; there is no implicit page repetition, clipping, truncation or lost/duplicated content.
...
- Limitation: T28 Unicode processing also applies to this paragraph version; T25 pagination adds no shaping, runtime font bundle, backend SPI, module cycle, placeholder artifact or Migration Facade mapping. Standards evidence and compatible-status Dependency Gates remain open.
...
- Context: `composition`
- Status: `experimental`
- Reference Suite source: `Issues 27 and 28, parent issue 1 and the public iText 7.2.6 Table API for fixed large-table restrictions; project-owned width/grid/pagination contract and independent numeric corpus`
- Reference role: capability inventory and public project contract; no Reference Suite implementation or output oracle
- Acceptance Profile: `T27-table-pagination`
- Mandatory evidence chains: `syntax`, `standards`, `semantic`, `visual`
- Evidence record: [`capabilities/evidence/T27-table-pagination.md`](../../capabilities/evidence/T27-table-pagination.md)
- Certified platforms: none

### Native Interface mapping

- `append-rows`: `net.zerocloud.pdf.composition.command.AppendTableRows`
- `begin-large-table`: `net.zerocloud.pdf.composition.command.BeginLargeTable`
...
- `failure`: `net.zerocloud.pdf.DocumentFailure`
- `flow`: `net.zerocloud.pdf.composition.ParagraphFlow`
- `flush-buffered-flow`: `net.zerocloud.pdf.composition.command.FlushParagraphs`
- `flush-table`: `net.zerocloud.pdf.composition.command.FlushTable`
- `inspect-large-table`: `net.zerocloud.pdf.composition.query.InspectLargeTable`
- `large-table-state`: `net.zerocloud.pdf.composition.LargeTableState`
- `limits`: `net.zerocloud.pdf.composition.CompositionLimits`
- `outcome`: `net.zerocloud.pdf.WorkflowOutcome`
...
- `public-pagination-workflow-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/consumer/TablePaginationWorkflowTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/consumer/TablePaginationWorkflowTest.java) — Both execution profiles observe independent breaks, complete scalar order, fragment geometry, repetition/omission, keeps, overflow, row-splitting policy, atomic relayout, sealing and exact resource boundaries through public Workflow and reopened queries.
- `public-incremental-workflow-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/consumer/LargeTableWorkflowTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/consumer/LargeTableWorkflowTest.java) — Both profiles verify release before all rows arrive, bounded generated state, incomplete spans, cumulative exact/first-excess counts/work/bytes, font lifetime, finite Worker transport, no premature publication, stable receipts and preserved incremental revisions.
- `independent-numeric-oracle`: [`pdf-acceptance/src/main/java/net/zerocloud/pdf/acceptance/T27TableExpectations.java`](../../pdf-acceptance/src/main/java/net/zerocloud/pdf/acceptance/T27TableExpectations.java) — Hand-declared breaks, glyphs and cell-border coordinates for nineteen fixed-font pages precede actual rendering; the reference path invokes only AddBlankPage, positioned text and Canvas.
- `independent-semantic-observer`: [`pdf-acceptance/src/main/java/net/zerocloud/pdf/acceptance/T27TableSemanticAssertions.java`](../../pdf-acceptance/src/main/java/net/zerocloud/pdf/acceptance/T27TableSemanticAssertions.java) — Reopened public values verify complete scalar order and metrics, page geometry, embedded subsets, transformed black border paths and missing/extraneous border detection against independent expectations.
- `acceptance-command`: [`pdf-acceptance/src/main/java/net/zerocloud/pdf/acceptance/T27TableEvidenceCommand.java`](../../pdf-acceptance/src/main/java/net/zerocloud/pdf/acceptance/T27TableEvidenceCommand.java) — The repository recorder retains separate pinned qpdf syntax, semantic and nineteen PDFium/ImageMagick page chains with input, font, oracle and raster hashes and fixed thresholds.
- `acceptance-negative-and-repeat-contract`: [`pdf-acceptance/src/test/java/net/zerocloud/pdf/acceptance/T27TableEvidenceCommandTest.java`](../../pdf-acceptance/src/test/java/net/zerocloud/pdf/acceptance/T27TableEvidenceCommandTest.java) — Missing content, an incorrect repeated header and a one-point geometry shift invalidate the independent semantic oracle; repeated recordings agree and missing pinned tools remain indeterminate.
- `authoritative-contract`: [`docs/table-pagination.md`](../table-pagination.md) — English declarations, fragment/repetition/keep/overflow rules, buffered and streaming lifecycles, independent examples, finite limits, stable failures and version migration agree with the Chinese usage guide; the T26 contract remains authoritative for version 1.
...
- `syntax`: `pass` — [`capabilities/evidence/T27-table-pagination-syntax.md`](../../capabilities/evidence/T27-table-pagination-syntax.md); producer `qpdf@12.4.0` (`external-tool`)
- `semantic`: `pass` — [`capabilities/evidence/T27-table-pagination-semantic.md`](../../capabilities/evidence/T27-table-pagination-semantic.md); producer `folio-pdf-t27-semantic-assertions@0.1.0-SNAPSHOT` (`project-test`)
...
- Limitation: Provider Operating Limits cover request bytes, result bytes, and elapsed subprocess time. T20 supplies cooperative policy for the surrounding workflow, while T21's separate document Worker leaves Provider selection and execution parent-brokered.
- Limitation: The generic Java 8 subprocess adapter supervises its direct child. T21's process-tree boundary contains the PDF Worker and does not certify arbitrary Capability Provider descendants.
...
- `cold-start-rendering-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/consumer/RenderingColdStartTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/consumer/RenderingColdStartTest.java) — A fresh JVM with an empty font cache and a project-authored installed font missing mandatory tables still renders substituted text, keeps font paths and document names private, restores caller log filters, and rejects an actual missing page resource. The test verifies discovery of the malformed font and makes no system-font compatibility claim.
...
- Certified platforms: `ubuntu-24.04-linux-x86-64-jdk8`, `ubuntu-24.04-linux-x86-64-jdk11`, `ubuntu-24.04-linux-x86-64-jdk17`, `ubuntu-24.04-linux-x86-64-jdk21`
...
- Stable: [`itext7.kernel.pdf-catalog.get-open-action`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_catalog_dot_get_dash_open_dash_action), [`itext7.kernel.pdf-catalog.set-open-action`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_catalog_dot_set_dash_open_dash_action), [`itext7.kernel.pdf-document.flatten-annotations`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_flatten_dash_annotations), [`itext7.kernel.pdf-document.get-actions`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_actions), [`itext7.kernel.pdf-document.get-annotations`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_annotations), [`itext7.kernel.pdf-document.update-annotations`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_update_dash_annotations), [`itext7.kernel.pdf-page.add-annotation`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_page_dot_add_dash_annotation), [`itext7.kernel.pdf-page.get-additional-actions`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_page_dot_get_dash_additional_dash_actions), [`itext7.kernel.pdf-page.get-annotations`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_page_dot_get_dash_annotations), [`itext7.kernel.pdf-page.remove-annotation`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_page_dot_remove_dash_annotation), [`itext7.kernel.pdf-page.set-additional-action`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_page_dot_set_dash_additional_dash_action), [`itext7.kernel.pdf-page.set-normal-appearance`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_page_dot_set_dash_normal_dash_appearance)
- Preview: none
...
- `annotation-facade-consumer-contract`: [`pdf-migration-itext7/src/test/java/net/zerocloud/pdf/itext7/consumer/AnnotationFacadeTest.java`](../../pdf-migration-itext7/src/test/java/net/zerocloud/pdf/itext7/consumer/AnnotationFacadeTest.java) — Stable and inherited Preview exercise all six families, page identity, appearance replacement, bounded reads, local catalog/page Actions, explicit and named Link activation, atomic invalid batches and non-Widget flattening through public Facade methods, reopened Native values and committed Publication Receipts.
- `annotation-independent-certification`: [`pdf-acceptance/src/test/java/net/zerocloud/pdf/acceptance/T12EvidenceCommandTest.java`](../../pdf-acceptance/src/test/java/net/zerocloud/pdf/acceptance/T12EvidenceCommandTest.java) — Sixteen exact Native and fixed-IN_PROCESS Facade products pass separate qpdf syntax, 174 independently qualified standards rules, independent qpdf object-graph semantics and original exact rasters; actual-product controls fail without changing frozen expectations; qualified Linux canaries observe inert unknown/chained Actions, atomic preserve-or-reject behavior and signed-Source protection in both Native profiles.
- `annotation-standards-qualification`: [`pdf-acceptance/src/test/java/net/zerocloud/pdf/acceptance/T12StandardsQualificationTest.java`](../../pdf-acceptance/src/test/java/net/zerocloud/pdf/acceptance/T12StandardsQualificationTest.java) — Every required predicate has an original illegal PDF and exact independently observed checker diagnostic, with original valid six-family and legal-boundary controls; missing tools, predicates or identity never pass.
...
- `syntax`: `pass` — [`capabilities/evidence/T74-annotations-syntax.md`](../../capabilities/evidence/T74-annotations-syntax.md); producer `qpdf@12.4.0` (`external-tool`)
- `standards`: `pass` — [`capabilities/evidence/T74-annotations-standards.md`](../../capabilities/evidence/T74-annotations-standards.md); producer `arlington-t12-r1@0.81-folio-t12-r1` (`external-tool`)
- `semantic`: `pass` — [`capabilities/evidence/T74-annotations-semantic.md`](../../capabilities/evidence/T74-annotations-semantic.md); producer `folio-pdf-t12@0.1.0` (`project-test`)
- `visual`: `pass` — [`capabilities/evidence/T74-annotations-visual.md`](../../capabilities/evidence/T74-annotations-visual.md); producer `pdfium-cli@v0.11.2-pdfium-chromium-7881` (`external-tool`)

Provenance: [`PROVENANCE.md`](../../PROVENANCE.md), record `T74 annotation certification work`.
...
- Stable: [`itext7.kernel.pdf-document.add-new-page`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_add_dash_new_dash_page), [`itext7.kernel.pdf-document.close`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_close), [`itext7.kernel.pdf-document.constructor-reader`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_constructor_dash_reader), [`itext7.kernel.pdf-document.constructor-writer`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_constructor_dash_writer), [`itext7.kernel.pdf-document.get-number-of-pages`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_number_dash_of_dash_pages), [`itext7.kernel.pdf-exception.constructor-message-cause`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_exception_dot_constructor_dash_message_dash_cause), [`itext7.kernel.pdf-page.get-pdf-object`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_page_dot_get_dash_pdf_dash_object), [`itext7.kernel.pdf-reader.close`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_reader_dot_close), [`itext7.kernel.pdf-reader.constructor-string`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_reader_dot_constructor_dash_string), [`itext7.kernel.pdf-writer.constructor-string`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_writer_dot_constructor_dash_string), [`itext7.layout.document.close`](facade-surface.md#facade-surface-itext7_dot_layout_dot_document_dot_close), [`itext7.layout.document.constructor-pdf-document`](facade-surface.md#facade-surface-itext7_dot_layout_dot_document_dot_constructor_dash_pdf_dash_document)
- Preview: none
...
- Limitation: T20 layers finite-default transaction-wide resource accounting and cooperative checkpoints onto T03. T21 separately supplies an opt-in isolated Worker with hard Worker termination; the caller callback intentionally remains in the caller process.
...
- `migration-facade-consumer-contract`: [`pdf-migration-itext7/src/test/java/net/zerocloud/pdf/itext7/consumer/BlankDocumentFacadeTest.java`](../../pdf-migration-itext7/src/test/java/net/zerocloud/pdf/itext7/consumer/BlankDocumentFacadeTest.java) — The shared Java 8 consumer exercises Stable and Preview publication, reopen, page counts, safe Native failures, Path release and close ownership.
- `migration-facade-artifact-contract`: [`pdf-migration-itext7/src/test/java/net/zerocloud/pdf/migration/itext7/contract/JarContractIT.java`](../../pdf-migration-itext7/src/test/java/net/zerocloud/pdf/migration/itext7/contract/JarContractIT.java) — Each actual jar matches its effective declared lifecycle surface with exact types, members, returns, generics and exceptions, Java 8 bytecode, module names and license resources; Preview includes every Stable mapping.
- `facade-classpath-exclusivity-contract`: [`pdf-migration-itext7/src/test/java/net/zerocloud/pdf/migration/itext7/contract/ClasspathExclusivityIT.java`](../../pdf-migration-itext7/src/test/java/net/zerocloud/pdf/migration/itext7/contract/ClasspathExclusivityIT.java) — Every mapped public class rejects stable-plus-preview classpaths observably in both jar orders.
...
- `acceptance-command`: [`scripts/t03-foundation.py`](../../scripts/t03-foundation.py) — The T03-only recorder binds exact candidate jars and four independent chains across the pinned JDK/execution matrix, retaining raw findings and negative controls.
...
- `syntax`: `pass` — [`capabilities/evidence/T70-transactions-syntax.md`](../../capabilities/evidence/T70-transactions-syntax.md); producer `qpdf@12.4.0` (`external-tool`)
- `standards`: `pass` — [`capabilities/evidence/T70-transactions-standards.md`](../../capabilities/evidence/T70-transactions-standards.md); producer `arlington@0.81` (`external-tool`)
- `semantic`: `pass` — [`capabilities/evidence/T70-transactions-semantic.md`](../../capabilities/evidence/T70-transactions-semantic.md); producer `folio-pdf-t03@0.1.0` (`project-test`)
- `visual`: `pass` — [`capabilities/evidence/T70-transactions-visual.md`](../../capabilities/evidence/T70-transactions-visual.md); producer `pdfium-cli@v0.11.2-pdfium-chromium-7881` (`external-tool`)

Provenance: [`PROVENANCE.md`](../../PROVENANCE.md), record `T70 independent standards qualification`.

<a id="capability-document_dot_hardened_dash_worker"></a>
...
- Context: `document-engine`
- Status: `experimental`
- Reference Suite source: `Java SE process, cryptography, permissions, and resource-ownership contracts plus Linux prlimit process-resource controls`
- Reference role: public platform contract input only; no third-party implementation, fixture, output, protocol, sandbox profile, or Reference Suite behavior is an oracle
- Acceptance Profile: `T21-hardened-worker`
- Mandatory evidence chains: `syntax`, `standards`, `semantic`, `visual`
- Evidence record: [`capabilities/evidence/T21-hardened-worker.md`](../../capabilities/evidence/T21-hardened-worker.md)
- Certified platforms: none
...
- `entry-point`: `net.zerocloud.pdf.DocumentWorkflow#execute`
- `environment`: `net.zerocloud.pdf.WorkflowEnvironment`
- `execution-profile`: `net.zerocloud.pdf.WorkflowExecutionProfile#HARDENED_WORKER`
- `failure`: `net.zerocloud.pdf.DocumentFailure`
- `failure-code`: `net.zerocloud.pdf.DocumentFailureCode`
- `outcome`: `net.zerocloud.pdf.WorkflowOutcome`
...
- `request`: `net.zerocloud.pdf.WorkflowRequest`
- `resource-policy`: `net.zerocloud.pdf.WorkflowResourcePolicy`
- `worker-settings`: `net.zerocloud.pdf.HardenedWorkerSettings`
...
- Dependency Gate: [`document.blank.create-publish-reopen`](#capability-document_dot_blank_dot_create_dash_publish_dash_reopen) must be `compatible`
- Dependency Gate: [`document.hostile-input-limits`](#capability-document_dot_hostile_dash_input_dash_limits) must be `compatible`
- Promotion gate `T06`: Complete every mandatory independent Acceptance Evidence chain and close both compatible-status Dependency Gates before compatibility; implementation and isolation tests alone are insufficient.
- Limitation: HARDENED_WORKER is an explicit per-request choice; IN_PROCESS remains the backward-compatible default. The caller callback and arbitrary caller code remain in the caller process against a thread-confined proxy Document Session, while only library-owned document work crosses the boundary.
...
- Limitation: Commands preserve declaration order through two closed batch transports. A batch made only of AddBlankPage, InsertBlankPage, CopyPages, MovePages, and RemovePages is eligible for an encoded-length offer while its complete modeled transport peak fits the parent's current message and aggregate owned-memory bounds. That peak is the larger of growable encoder capacity plus retained payload and simultaneous parent/child payload ownership plus the retained/received completion control. It crosses in one atomic frame only when the Worker accepts its current modeled-memory cost. Every other, parent-ineligible, or Worker-deferred batch sends one authenticated declaration fixing the complete ordered count, then sends each indexed preflight, required detail, and Command only when the Worker requests it after its predecessor succeeds. Both forms receive one logical completion. Encoding or materializing later staged Commands is deferred, so execution stops at the first failure without consuming later one-shot inputs or allowing a later resource failure to replace an earlier semantic or backend failure. Execute delegates its singleton batch through the same selection, and each Query is a synchronous ordering barrier. Lazy PDF Value views use bounded authenticated operations, remain serviceable while the Worker awaits a deferred item so they can be used by a later Command, and expire with their proxy Session. Nested PDF Value, outline, and logical-structure codecs are iterative through the public version-1 nesting ceiling. At the T21 fixed point each value fit one configured message; the separate T22 recovery-and-scale capability adds bounded authenticated chunking.
- Limitation: The parent snapshots the primary Source before launch under an owner-restricted random transaction root. During Worker initialization, every other named Source is requested, snapshotted, and classified one at a time in declaration order, so an earlier failure does not open a later one-shot Source. The Worker receives only random local handles; the parent retains actual Targets and caller-owned streams or channels and publishes only after a valid finished response and confirmed Worker exit. Reference Font Set entries and explicit Font Sources remain parent-owned and unopened until selected. The selecting Command applies declaration and source-count checks and carries opaque identifiers; the Worker requests each program in declaration order, and the parent applies the aggregate-byte, first-excess, and one-shot reuse rules before returning it in a separate bounded frame. Committed Worker products remain cumulatively charged to the shared temporary-storage ceiling. Existing Save Mode, receipt, partial-stream, replacement, and Provider-selection contracts remain authoritative.
- Limitation: The supported launcher is Linux with executable /usr/bin/prlimit, separate unshaded Folio PDF production artifacts or project-only exploded production class directories, and a JDK 8, 11, 17, or 21 runtime capable of installing SecurityManager. It clears the child environment; requires digest-pinned exact first-party class-name inventories and complete-byte SHA-256 matches for every dependency JAR, including an installed optional TIFF closure; rejects mixed, incomplete, extra, multi-release, manifest-extended, delimiter-bearing, or wildcard-bearing classpath entries; fixes heap and direct-memory maxima, stack size, CPU time and open-file count; and denies Worker INET and Unix-domain network, descendant process, link, and filesystem access outside the transaction/runtime roots. Caller-thread checkpoints retain the original environment Clock and deadline authority, while a monotonic watchdog supplies an independent hard Worker-lifetime ceiling and RLIMIT_CPU supplies an independent CPU ceiling. Heap/direct-memory ceilings are not a complete RSS, native-allocation, kernel, or container limit, and no certified-platform or complete OS-sandbox claim is made.
- Limitation: Authenticated child STAGED and VALIDATED frames preserve progress boundaries while listener invocation and environment-Clock/deadline checks remain parent-owned and caller-thread-confined. One synchronized parent ledger accounts parent-live allocations and all reported child allocations without a static split. Before every nonempty parent-to-child application frame, the parent reserves and grants its exact payload allocation; the child reserves and releases other decoded or retained allocations through authenticated memory controls; and each quiescent response is followed by an acknowledged empty memory synchronization before the next parent allocation. Atomic-batch eligibility includes the larger of the parent's growable encoder plus retained-payload peak and simultaneous parent/child payload ownership plus the retained/received completion control. Active-context application payloads, decoded String/byte copies, conservatively charged collection capacity, credentials, and normal failure envelopes are cleared or released at their actual lifetime boundaries without sampling the caller Clock on the reader thread. Fixed 12-byte authenticated memory reserve, release, and grant payloads are the sole active control-plane exception and remain outside the ledger to prevent recursive accounting while retaining pre-allocation message-bound checks. Pre-context and post-context failures use a fixed eight-byte allowlisted descriptor, and the fixed eight-byte post-context FINISHED control contains only a version and allowlisted capability token, because no transaction ledger is live. Counts are checked against remaining wire bytes and charged before capacity-bearing allocation. The bootstrap decoder applies the parent-supplied memory ceiling before the child context exists, and decoded initialization collection capacity remains charged for the active transaction after READY; the fixed failure codec remains available as an emergency only when the primary failure has already poisoned or exhausted an active context.
- Limitation: Capability Providers remain selected and executed by the parent under their existing operating limits and Remote Disclosure Authorization. No Provider instance, remote connection, private key, arbitrary class, callback, backend object, or executable extension crosses into the Worker. Initialization contains only password-security descriptors and credential-presence flags; credential characters remain parent-side until requested in protocol order, and bounded clearable character and protocol-buffer copies are accounted and cleared on lifecycle boundaries without claiming physical secure erasure.
- Limitation: T21 is the base Worker boundary and supplies no remote Worker, public backend SPI, or renderer. The separate T22 recovery-and-scale capability extends this implementation with environment-local identities, lookup, bounded chunking, and controlled scale evidence without changing those exclusions.

### Evidence

Implementation evidence:

- `public-worker-workflow-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/consumer/HardenedWorkerWorkflowTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/consumer/HardenedWorkerWorkflowTest.java) — Public workflows select the Worker, carry both a memory-negotiated atomic page-structure batch and a declared ordered batch through Worker-requested indexed preflights, details, and items with one logical completion, stop before consuming later one-shot inputs, preserve earlier semantic and backend failures over later transport or resource failures, preserve Query barriers, transport fixed-point command/query/value forms including optional embedded-file values and descriptor-only output policy with on-demand credentials, enforce aggregate transport memory bounds, retain incremental publication, reject caller-defined operations, publish through parent-owned Targets, and report the selected profile.
- `shared-execution-profile-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/consumer/WorkflowExecutionProfileContractTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/consumer/WorkflowExecutionProfileContractTest.java) — Parameterized public tests hold IN_PROCESS and HARDENED_WORKER to the same ordering, lifecycle, ownership, Save Mode, receipt including post-publication cleanup failure, checked-primary cleanup suppression, progress, cancellation, deadline, caller-thread Clock observation, stable-failure, resource-policy, result-identity, lazy font, exact aggregate font-byte, lossless String-validation, recoverable lazy-view-index and lazy-value-as-command-input behavior, and callback-exception contract. Cross-profile regressions also prove protected-document and signed-Widget failures before later oversized values, Canvas semantic and preservation failures before later image transport, exact once-only Canvas preservation decoding for both command versions, lowered workflow nesting limits for nested transparency, and terminal resource-failure precedence after a callback catches the immediate failure.
- `process-isolation-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/HardenedWorkerIsolationTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/HardenedWorkerIsolationTest.java) — Real Worker executions prove separate process identity, owner-restricted nondisclosing roots, INET and Unix-domain connect/listen denial, descendant-process denial, denial of reads and writes against marker data in another concurrently live transaction root, hard elapsed termination including preservation of its failure code during startup with a fixed logical Clock, target preservation, sequential cleanup, and cleanup after supported exits. Classpath tests prove exact project inventory and dependency-JAR acceptance plus fail-closed rejection of mixed, extra, multi-release, delimiter-bearing, and wildcard-bearing entries and modified dependency JARs.
- `authenticated-protocol-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/WorkerProtocolBoundaryTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/WorkerProtocolBoundaryTest.java) — Tests use the real Worker process boundary to prove exact message and memory-control boundaries, pre-allocation oversized rejection, receive-grant enforcement, aggregate reserve/release synchronization across atomic and indexed wait states, progress acknowledgement, authentication and tamper failure, replay rejection, unknown version and opcode rejection, malformed length and trailing-data rejection, valid-opcode rejection of class, reflection, script, and URI discriminator attempts, Java Serialization rejection, and preservation of every sentinel product.
- `fixed-point-codec-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/WorkerCodecContractTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/WorkerCodecContractTest.java) — Internal explicit-codec tests prove exact and first-excess full atomic-transport peak eligibility for both dominating peak shapes, a fixed eight-byte allowlisted finished control with an exact first-excess boundary, malformed scalar rejection, indexed later-item message failure, and iterative PDF Value, outline, and logical-structure round trips through the full public nesting ceiling; these are codec unit contracts, not substitutes for real Worker protocol-boundary tests.
- `transport-resource-accounting-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/WorkflowResourceCacheAccountingTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/WorkflowResourceCacheAccountingTest.java) — Direct resource-context tests prove decoded String/byte reservations are released at their message or returned-request consumer boundaries, decoded credentials are destroyed before releasing their retained-memory reservation, input-resolver ownership closes while the workflow context is still live, decoded collection capacity is charged before allocation with an exact first-excess boundary, a failed recovery keeps the already-observed failure authoritative while making the transaction terminal, closed contexts use only the fixed post-context failure control, and an already exhausted active memory context still reports its authenticated stable failure through the bounded emergency codec.
- `authoritative-contract`: [`docs/hardened-worker.md`](../hardened-worker.md) — Selection, callback placement, protocol, ordering, ownership, publication, credentials, Providers, exact classpath authority, supported Linux/JDK envelope, resource and isolation controls, cleanup, stable failures, and the additive T22 recovery-and-scale boundary are documented.
- `dependency-integrity-record`: [`DEPENDENCIES.md`](../../DEPENDENCIES.md) — The complete-byte SHA-256 authority for every required and optional Worker dependency JAR is recorded without adding, shading, or redistributing a dependency.
- `public-api-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/contract/PublicApiLeakageIT.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/contract/PublicApiLeakageIT.java) — Public and protected Worker selection and settings signatures remain Java 8 compatible and expose only project-owned or JDK types.
- `artifact-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/contract/JarContractIT.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/contract/JarContractIT.java) — The document jar retains its stable module identity, Java 8 class files, notices, and private Worker implementation without a new product module or bundled dependency.
- `cross-jdk-contract`: [`scripts/verify-jdk-matrix.sh`](../../scripts/verify-jdk-matrix.sh) — Maven verification runs public workflow, protocol, isolation, API, artifact, and regression contracts on JDK 8, 11, 17, and 21.

Acceptance Evidence: incomplete; no independent chain has been recorded as passing.

Provenance: [`PROVENANCE.md`](../../PROVENANCE.md), record `T21 hardened-worker record`.

<a id="capability-document_dot_hardened_dash_worker_dot_recovery_dash_scale"></a>
...
- Context: `document-engine`
- Status: `experimental`
- Reference Suite source: `Java SE identity, digest, resource-ownership, process, and concurrency contracts plus Linux platform observations`
- Reference role: public platform contract and controlled implementation evidence only; no third-party implementation, fixture, output, idempotency protocol, or Reference Suite behavior is an oracle
- Acceptance Profile: `T22-worker-recovery-scale`
- Mandatory evidence chains: `syntax`, `standards`, `semantic`, `visual`
- Evidence record: [`capabilities/evidence/T22-worker-recovery-scale.md`](../../capabilities/evidence/T22-worker-recovery-scale.md)
- Certified platforms: none
...
- `failure`: `net.zerocloud.pdf.DocumentFailure`
- `failure-code`: `net.zerocloud.pdf.DocumentFailureCode`
- `lookup`: `net.zerocloud.pdf.DocumentWorkflow#lookupTransaction`
- `outcome`: `net.zerocloud.pdf.WorkflowOutcome`
- `receipt`: `net.zerocloud.pdf.PublicationReceipt`
- `request`: `net.zerocloud.pdf.WorkflowRequest`
- `resource-policy`: `net.zerocloud.pdf.WorkflowResourcePolicy`
- `resource-usage`: `net.zerocloud.pdf.WorkflowResourceUsage`
- `transaction-id`: `net.zerocloud.pdf.WorkflowTransactionId`
- `transaction-policy`: `net.zerocloud.pdf.WorkflowTransactionPolicy`
- `transaction-state`: `net.zerocloud.pdf.WorkflowTransactionState`
- `transaction-status`: `net.zerocloud.pdf.WorkflowTransactionStatus`
...
- Dependency Gate: [`document.hardened-worker`](#capability-document_dot_hardened_dash_worker) must be `compatible`
- Promotion gate `T06`: Complete every mandatory independent Acceptance Evidence chain and close the compatible-status T21 Dependency Gate before compatibility; implementation recovery, protocol, and controlled scale observations alone are insufficient.
- Limitation: Workflow Transaction Identity is optional, bounded, non-secret, and accepted only with HARDENED_WORKER. Status belongs to one Workflow Environment's finite non-evicting in-memory ledger, whose defaults allow 4,096 identities and 64 KiB of modeled request/status/receipt metadata per identity (a 256 MiB aggregate modeled ceiling, not JVM heap or RSS); it is neither durable across environment or process lifetime nor global, distributed, or automatically retried. Count exhaustion or an oversized envelope rejects a new identity before callback or publication; an oversized pre-admission declaration creates no status and may omit receipts rather than copying over-limit metadata. Byte Sources capture a content digest with their defensive copy, and bounded fingerprint work occurs outside the synchronized ledger.
- Limitation: An identity binds the material request envelope, including ordered Source and Target declarations, Path locations, byte-source contents, caller-owned resource and credential object identities, Save Mode, output security, and Provider choices. Deadline, cancellation, listener, and resource policy are fresh attempt controls. Because caller callback meaning and mutable Path contents cannot be fingerprinted, the application must preserve their logical meaning across a recoverable retry and must restore the same caller-owned Source stream or channel to its original readable position; an unrepeatable one-shot Source is unsuitable for retry. The ledger retains weak, not owning, identities for streams, channels, outputs, and credentials.
- Limitation: Concurrent reuse fails before caller work. A materially different envelope fails with TRANSACTION_IDENTITY_MISMATCH. Only an all-NOT_ATTEMPTED cancellation, deadline, elapsed-time, concurrency, Worker-unavailable, authentication, protocol, or termination failure is RECOVERABLE. COMPLETED and FAILED states are final and repeated submissions fail before callback or publication; Folio PDF never automatically retries.
- Limitation: Parent-observed publication progress retains declaration-ordered receipts. Loss of the caller acknowledgement after every Path or stream Target commits resolves as COMPLETED through lookup and cannot replay. Any stream write that may have emitted partial bytes is FAILED with partialOutputPossible and is terminal. Path publication remains ordered and cross-Target atomicity is not claimed.
- Limitation: Every physical protocol frame retains its configured payload bound, monotonic sequence, and HMAC. A larger logical value uses a direction-unique transfer identity, declared application opcode, total length, exact chunk count, ordered chunk indexes, and SHA-256 digest. The complete payload plus one maximum-frame receive buffer must pass aggregate modeled-memory admission before allocation; every top-level declaration or chunk reserves that frame scratch before allocation, and a valid transfer reuses the declaration reservation across expected chunks. Missing, reordered, duplicate, corrupt, mismatched, malformed, or excess transfer data fails safely, clears buffers, releases reservations, and cannot mutate an uncommitted Target. This is bounded in-memory chunking, not unbounded streaming or temporary-file staging.
- Limitation: Workflow Resource Usage combines parent and authenticated child observations for accepted input, pages, objects, decompression, pixels, peak modeled Folio-owned memory, peak transaction temporary storage, and elapsed time. It is not JVM heap, process RSS, native/backend allocation, operating-system cache, kernel-limit, nesting, or concurrency measurement.
- Limitation: Opt-in generated profiles exercise 5,000-page publish/reopen semantics, exact 1-GiB constant-memory clean-room input/staging and cleanup, and admission at configured concurrency two with deterministic first-excess rejection and retry after release. The recorded Linux 6.8.0-136-generic amd64 and GraalVM Community Java 17.0.9 observations are implementation evidence for one platform, not a benchmark, cross-platform result, mandatory independent Acceptance Evidence, or certified-platform claim.
- Limitation: T22 adds no remote Worker, durable recovery store, renderer, downstream ticket behavior, public backend SPI, arbitrary extension mechanism, Migration Facade mapping, whole-process memory guarantee, kernel-container certification, physical secure-erasure claim, or cross-Target transaction.

### Evidence

Implementation evidence:

- `public-transaction-recovery-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/consumer/HardenedWorkerRecoveryTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/consumer/HardenedWorkerRecoveryTest.java) — Public workflows prove bounded Worker-only identities, count- and modeled-metadata-bounded environment-local retention, pre-admission oversized-envelope rejection without a ledger slot, reconstructed byte-content identity, RUNNING duplicate rejection, material-envelope mismatch rejection, completed lookup, declaration-ordered lost-acknowledgement receipts, no final replay, recoverable cancellation and timeout with fresh attempt controls, Path preservation, and terminal fully committed or possibly partial stream semantics.
- `worker-recovery-fault-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/HardenedWorkerRecoveryFaultTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/HardenedWorkerRecoveryFaultTest.java) — Package-private fault injection at the real child-process seam proves Worker death and authenticated malformed responses produce deterministic recoverable states with not-attempted receipts, preserve Targets, clean owned roots, and permit one public retry.
- `authenticated-large-value-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/WorkerProtocolBoundaryTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/WorkerProtocolBoundaryTest.java) — Exact aggregate receive capacity succeeds and the first excess fails before wire output or unbounded allocation; an authenticated trailing transfer chunk requires frame scratch before payload allocation; missing, reordered, duplicate, corrupt, wrong-identity, wrong-length, wrong-digest, and excess transfers fail with stable safe outcomes while preserving the sentinel Target and releasing resource ownership.
- `public-large-value-and-usage-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/consumer/HardenedWorkerWorkflowTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/consumer/HardenedWorkerWorkflowTest.java) — A metadata value larger than one configured message crosses parent to child and child to parent, publishes, and reopens through the public Worker seam; successful outcomes expose combined resource high-water observations within the declared policy.
- `resource-usage-codec-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/WorkerCodecContractTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/WorkerCodecContractTest.java) — The authenticated child resource-usage control has one fixed 72-byte form with exact-bound success, first-excess refusal, version validation, nonnegative counters, and valid elapsed-time fields.
- `controlled-scale-profile`: [`pdf-document/src/test/java/net/zerocloud/pdf/consumer/HardenedWorkerScaleProfileTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/consumer/HardenedWorkerScaleProfileTest.java) — Opt-in public-seam tests generate and verify the 5,000-page, exact 1-GiB, and configured-concurrency workloads, assert semantic results, ownership and cleanup, deterministic first-excess behavior, and modeled memory, temporary-storage, and elapsed usage within the full recorded policy.
- `controlled-scale-command`: [`scripts/t22-scale`](../../scripts/t22-scale) — The repository-owned command selects all, pages, input, or concurrency and emits exact platform, construction, policy, usage, elapsed, and concurrency records without retaining a large fixture.
- `authoritative-contract`: [`docs/hardened-worker.md`](../hardened-worker.md) — Recovery, lookup, retention, retry, target-specific uncertainty, bounded authenticated chunking, resource-usage semantics, controlled scale profiles, exact observations, and remaining limitations are documented.
- `public-api-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/contract/PublicApiLeakageIT.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/contract/PublicApiLeakageIT.java) — Public transaction, status, resource-usage, request, outcome, failure, environment, and workflow signatures remain Java 8 compatible and expose only project-owned or JDK types.
- `artifact-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/contract/JarContractIT.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/contract/JarContractIT.java) — The document jar retains its stable module identity, Java 8 class files, notices, private protocol implementation, exact Worker inventory, and existing unshaded dependency set.
- `cross-jdk-contract`: [`scripts/verify-jdk-matrix.sh`](../../scripts/verify-jdk-matrix.sh) — Maven verification runs the default recovery, protocol, API, artifact, and regression contracts on JDK 8, 11, 17, and 21; the resource-intensive scale profiles remain separately opt-in.

Acceptance Evidence: incomplete; no independent chain has been recorded as passing.

Provenance: [`PROVENANCE.md`](../../PROVENANCE.md), record `T22 worker-recovery-scale record`.

<a id="capability-document_dot_hostile_dash_input_dash_limits"></a>
...
- Context: `document-engine`
- Status: `experimental`
- Reference Suite source: `ISO 32000-1:2008 document, object, stream-filter, page, and image resource concepts plus Java SE time, concurrency, and storage contracts`
- Reference role: public specification input only; no third-party implementation, fixture, output, or resource profile is an oracle
- Acceptance Profile: `T20-hostile-input-limits`
- Mandatory evidence chains: `syntax`, `standards`, `semantic`, `visual`
- Evidence record: [`capabilities/evidence/T20-hostile-input-limits.md`](../../capabilities/evidence/T20-hostile-input-limits.md)
- Certified platforms: none
...
- Dependency Gate: [`document.blank.create-publish-reopen`](#capability-document_dot_blank_dot_create_dash_publish_dash_reopen) must be `compatible`
- Dependency Gate: [`document.value.inspect-patch`](#capability-document_dot_value_dot_inspect_dash_patch) must be `compatible`
- Promotion gate `T06`: Complete every mandatory independent Acceptance Evidence chain and close both compatible-status Dependency Gates before compatibility; implementation tests alone are insufficient.
...
- Limitation: One enforcement context spans primary and additional named Sources, Commands, Queries, Document Patches, distinct streams and images, split products, validation, and every publication Target; each applicable counter therefore continues across those phases instead of being recreated. Existing operation-local limits still apply, and the first stricter bound exhausted retains its owning stable failure.
- Limitation: Path, stream, channel, and byte-array Sources are copied through actual-byte accounting before parsing. Source snapshots, supported filter spill, temp-only PDFBox cache growth, staged documents and products, and target-adjacent commit staging share one quota and transaction-owned cleanup lifecycle under the configured environment storage policy.
- Limitation: Whole-document resource accounting is iterative and runs before caller work and after each Session operation. Malformed page trees, impossible image declarations, and unsupported or malformed filters retain the more specific owning operation's established failure when they do not exhaust a resource policy.
- Limitation: Cancellation, absolute deadlines, and elapsed-time checks are cooperative inside project-owned reads, graph, page, metadata, annotation and extraction traversals, backend-cache I/O, Patch, Canvas and positioned-text paths, staging, incremental validation, and publication. A policy failure is terminal even when caller code catches it. Path commitment remains replacement-safe; streams and multiple Targets retain T03 partial-output and non-global-atomicity semantics.
- Limitation: Accounted owned memory covers integrated Folio byte lifetimes and working buffers, while PDFBox cache is forced to quota-controlled temporary storage. It is not a JVM-wide, caller-allocation, backend-allocation, native-memory, CPU, or operating-system hard limit and makes no physical secure-erasure claim.
- Limitation: T20 itself remains the trusted in-process profile. T21 separately supplies the opt-in Hardened Worker boundary for hostile multi-tenant execution; runtime rendering remains T23.

### Evidence

Implementation evidence:

- `hostile-input-public-workflow-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/consumer/HostileInputWorkflowTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/consumer/HostileInputWorkflowTest.java) — Public DocumentWorkflow executions prove immutable finite defaults and overrides; exact boundary and first excess for all ten limits; aggregate Sources, repeated decoding, and Patch accounting; deterministic cancellation, deadline, concurrency and cleanup behavior; terminal poisoning; stable safe diagnostics; and publication protection using only project-owned fixtures and public types.
- `transaction-regression-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/consumer/WorkflowTransactionContractTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/consumer/WorkflowTransactionContractTest.java) — Save Mode, validation, cancellation, deadline, progress, multi-Target receipt, replacement, and partial-stream behavior remain observable under the shared policy.
- `resource-ownership-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/consumer/WorkflowResourceOwnershipTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/consumer/WorkflowResourceOwnershipTest.java) — Workflow-owned Path resources and caller-owned streams, channels, and outputs retain their established lifetime on success, checked failure, and caller exception.
- `pdf-value-regression-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/consumer/PdfValueWorkflowTest.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/consumer/PdfValueWorkflowTest.java) — Lazy bounded stream access and validated Document Patches retain their public lifecycle and stable failures while consuming the transaction-wide decompression and nesting policy.
- `authoritative-policy`: [`docs/hostile-input-policy.md`](../hostile-input-policy.md) — Defaults, accounting boundaries, local-limit composition, stable failures, cleanup, publication behavior, cooperative limits, and composition with the separate T21 isolation boundary are documented.
- `public-api-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/contract/PublicApiLeakageIT.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/contract/PublicApiLeakageIT.java) — Public and protected T20 signatures remain Java 8 compatible and expose only project-owned or JDK types.
- `artifact-contract`: [`pdf-document/src/test/java/net/zerocloud/pdf/contract/JarContractIT.java`](../../pdf-document/src/test/java/net/zerocloud/pdf/contract/JarContractIT.java) — The document artifact retains its module identity, Java 8 class files, notices, and private unshaded backend.
- `cross-jdk-contract`: [`scripts/verify-jdk-matrix.sh`](../../scripts/verify-jdk-matrix.sh) — Maven verification runs the T20 public workflow and regression contracts on JDK 8, 11, 17, and 21.

Acceptance Evidence: incomplete; no independent chain has been recorded as passing.

Provenance: [`PROVENANCE.md`](../../PROVENANCE.md), record `T20 trusted-in-process hostile-input-policy record`.
...
- Stable: [`itext7.kernel.pdf-document-info.add-creation-date`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_add_dash_creation_dash_date), [`itext7.kernel.pdf-document-info.add-mod-date`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_add_dash_mod_dash_date), [`itext7.kernel.pdf-document-info.get-author`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_get_dash_author), [`itext7.kernel.pdf-document-info.get-creator`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_get_dash_creator), [`itext7.kernel.pdf-document-info.get-entries`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_get_dash_entries), [`itext7.kernel.pdf-document-info.get-keywords`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_get_dash_keywords), [`itext7.kernel.pdf-document-info.get-more-info`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_get_dash_more_dash_info), [`itext7.kernel.pdf-document-info.get-producer`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_get_dash_producer), [`itext7.kernel.pdf-document-info.get-subject`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_get_dash_subject), [`itext7.kernel.pdf-document-info.get-title`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_get_dash_title), [`itext7.kernel.pdf-document-info.get-trapped`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_get_dash_trapped), [`itext7.kernel.pdf-document-info.set-author`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_set_dash_author), [`itext7.kernel.pdf-document-info.set-creator`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_set_dash_creator), [`itext7.kernel.pdf-document-info.set-keywords`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_set_dash_keywords), [`itext7.kernel.pdf-document-info.set-more-info`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_set_dash_more_dash_info), [`itext7.kernel.pdf-document-info.set-more-info-map`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_set_dash_more_dash_info_dash_map), [`itext7.kernel.pdf-document-info.set-producer`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_set_dash_producer), [`itext7.kernel.pdf-document-info.set-subject`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_set_dash_subject), [`itext7.kernel.pdf-document-info.set-title`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_set_dash_title), [`itext7.kernel.pdf-document-info.set-trapped`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_set_dash_trapped), [`itext7.kernel.pdf-document-info.update-entries`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dash_info_dot_update_dash_entries), [`itext7.kernel.pdf-document.add-file-attachment`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_add_dash_file_dash_attachment), [`itext7.kernel.pdf-document.add-named-destination`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_add_dash_named_dash_destination), [`itext7.kernel.pdf-document.constructor-named-sources-targets-version`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_constructor_dash_named_dash_sources_dash_targets_dash_version), [`itext7.kernel.pdf-document.get-document-info`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_document_dash_info), [`itext7.kernel.pdf-document.get-file-attachment`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_file_dash_attachment), [`itext7.kernel.pdf-document.get-file-attachments`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_file_dash_attachments), [`itext7.kernel.pdf-document.get-named-destinations`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_named_dash_destinations), [`itext7.kernel.pdf-document.get-outlines`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_outlines), [`itext7.kernel.pdf-document.get-xmp-metadata`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_xmp_dash_metadata), [`itext7.kernel.pdf-document.get-xmp-metadata-bounded`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_xmp_dash_metadata_dash_bounded), [`itext7.kernel.pdf-document.set-named-destinations`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_set_dash_named_dash_destinations), [`itext7.kernel.pdf-document.set-outlines`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_set_dash_outlines), [`itext7.kernel.pdf-document.set-xmp-metadata`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_set_dash_xmp_dash_metadata)
- Preview: none
...
- `migration-facade-consumer-contract`: [`pdf-migration-itext7/src/test/java/net/zerocloud/pdf/itext7/consumer/DocumentMetadataFacadeTest.java`](../../pdf-migration-itext7/src/test/java/net/zerocloud/pdf/itext7/consumer/DocumentMetadataFacadeTest.java) — Public Stable and Preview consumers prove equivalent reopened document information, XMP, outline, destination, embedded-file, page-retargeting, collision, preservation, ownership, lifecycle, failure, Publication Receipt, and Source-isolation results through the fixed IN_PROCESS Facade.
- `migration-facade-artifact-contract`: [`pdf-migration-itext7/src/test/java/net/zerocloud/pdf/migration/itext7/contract/JarContractIT.java`](../../pdf-migration-itext7/src/test/java/net/zerocloud/pdf/migration/itext7/contract/JarContractIT.java) — Actual Stable and Preview jars exactly match every declared PdfDocument and PdfDocumentInfo metadata member; Preview retains Stable, both artifacts use Java 8 bytecode, and no undeclared public type is present.
- `facade-classpath-exclusivity-contract`: [`pdf-migration-itext7/src/test/java/net/zerocloud/pdf/migration/itext7/contract/ClasspathExclusivityIT.java`](../../pdf-migration-itext7/src/test/java/net/zerocloud/pdf/migration/itext7/contract/ClasspathExclusivityIT.java) — Stable-plus-Preview classpaths reject observably in either jar order after the metadata surface is added.
- `acceptance-command`: [`pdf-acceptance/src/main/java/net/zerocloud/pdf/acceptance/T11EvidenceCommand.java`](../../pdf-acceptance/src/main/java/net/zerocloud/pdf/acceptance/T11EvidenceCommand.java) — The repository-only command produces eight exact Native and Facade metadata PDFs plus separate syntax, standards, semantic, visual, XML safety, signed-document protection, and real negative-control records from the frozen corpus.
- `foundation-certification-command`: [`scripts/t03-foundation.py`](../../scripts/t03-foundation.py) — Candidate-bound T11 recording runs JDK 8, 11, 17 and 21 with Native IN_PROCESS and HARDENED_WORKER while recording Facade execution separately as IN_PROCESS and retaining all products, reports, controls, tools, environment observations and safety evidence.

Acceptance Evidence:

- `syntax`: `pass` — [`capabilities/evidence/T73-metadata-syntax.md`](../../capabilities/evidence/T73-metadata-syntax.md); producer `qpdf@12.4.0` (`external-tool`)
- `standards`: `pass` — [`capabilities/evidence/T73-metadata-standards.md`](../../capabilities/evidence/T73-metadata-standards.md); producer `arlington-t11-r1@0.81-folio-t11-r1` (`external-tool`)
- `semantic`: `pass` — [`capabilities/evidence/T73-metadata-semantic.md`](../../capabilities/evidence/T73-metadata-semantic.md); producer `folio-pdf-t11@0.1.0` (`project-test`)
- `visual`: `pass` — [`capabilities/evidence/T73-metadata-visual.md`](../../capabilities/evidence/T73-metadata-visual.md); producer `pdfium-cli@v0.11.2-pdfium-chromium-7881` (`external-tool`)
...
- Limitation: T10 validates command ranges, positions, named merge Sources, and exact split Target coverage. A successful SplitDocument is terminal for Document Commands in that workflow; its local limits compose with T20's transaction-wide page, object, nesting, decompression, memory, time, storage, input, pixel, and concurrency policy.
- Limitation: T10 runs through the trusted in-process adapter by default; T21's opt-in Hardened Worker transports the same page, merge, and split commands and queries through closed version-1 codecs.
...
- `migration-facade-consumer-contract`: [`pdf-migration-itext7/src/test/java/net/zerocloud/pdf/itext7/consumer/PageManipulationFacadeTest.java`](../../pdf-migration-itext7/src/test/java/net/zerocloud/pdf/itext7/consumer/PageManipulationFacadeTest.java) — Public consumers prove equivalent order, named Source selection, complete split Target coverage, page-handle ownership, Source and sibling isolation, terminal Commands, safe failures and ordered publication receipts through the fixed IN_PROCESS Facade.
- `migration-facade-artifact-contract`: [`pdf-migration-itext7/src/test/java/net/zerocloud/pdf/migration/itext7/contract/JarContractIT.java`](../../pdf-migration-itext7/src/test/java/net/zerocloud/pdf/migration/itext7/contract/JarContractIT.java) — Actual Stable and Preview jars exactly match all declared page, merger and splitter types and members; Preview retains Stable and both artifacts use Java 8 bytecode.
- `facade-classpath-exclusivity-contract`: [`pdf-migration-itext7/src/test/java/net/zerocloud/pdf/migration/itext7/contract/ClasspathExclusivityIT.java`](../../pdf-migration-itext7/src/test/java/net/zerocloud/pdf/migration/itext7/contract/ClasspathExclusivityIT.java) — Stable-plus-Preview classpaths reject observably in either jar order.
- `acceptance-command`: [`pdf-acceptance/src/main/java/net/zerocloud/pdf/acceptance/T10EvidenceCommand.java`](../../pdf-acceptance/src/main/java/net/zerocloud/pdf/acceptance/T10EvidenceCommand.java) — The repository-only command produces eight exact Native/Facade PDFs and separate syntax, standards, semantic and per-page visual records with real negative controls.
- `foundation-certification-command`: [`scripts/t03-foundation.py`](../../scripts/t03-foundation.py) — Candidate-bound T10 recording runs JDK 8, 11, 17 and 21 with Native IN_PROCESS and HARDENED_WORKER while recording Facade execution separately as IN_PROCESS.

Acceptance Evidence:

- `syntax`: `pass` — [`capabilities/evidence/T72-pages-syntax.md`](../../capabilities/evidence/T72-pages-syntax.md); producer `qpdf@12.4.0` (`external-tool`)
- `standards`: `pass` — [`capabilities/evidence/T72-pages-standards.md`](../../capabilities/evidence/T72-pages-standards.md); producer `arlington-t10-r1@0.81-folio-t10-r1` (`external-tool`)
- `semantic`: `pass` — [`capabilities/evidence/T72-pages-semantic.md`](../../capabilities/evidence/T72-pages-semantic.md); producer `folio-pdf-t10@0.1.0` (`project-test`)
- `visual`: `pass` — [`capabilities/evidence/T72-pages-visual.md`](../../capabilities/evidence/T72-pages-visual.md); producer `pdfium-cli@v0.11.2-pdfium-chromium-7881` (`external-tool`)
...
- `stream-encoding`: `net.zerocloud.pdf.PdfStreamEncoding`
- `value`: `net.zerocloud.pdf.PdfValue`
- `value-kind`: `net.zerocloud.pdf.PdfValueKind`
- `value-path`: `net.zerocloud.pdf.PdfValuePath`

### Migration Facade coverage

- Stable: [`itext7.kernel.pdf-array.add`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_add), [`itext7.kernel.pdf-array.add-at-index`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_add_dash_at_dash_index), [`itext7.kernel.pdf-array.constructor`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_constructor), [`itext7.kernel.pdf-array.constructor-list`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_constructor_dash_list), [`itext7.kernel.pdf-array.get`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_get), [`itext7.kernel.pdf-array.get-as-direct`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_get_dash_as_dash_direct), [`itext7.kernel.pdf-array.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_get_dash_type), [`itext7.kernel.pdf-array.remove`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_remove), [`itext7.kernel.pdf-array.set`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_set), [`itext7.kernel.pdf-array.size`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_array_dot_size), [`itext7.kernel.pdf-boolean.constant-false`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_boolean_dot_constant_dash_false), [`itext7.kernel.pdf-boolean.constant-true`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_boolean_dot_constant_dash_true), [`itext7.kernel.pdf-boolean.constructor-boolean`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_boolean_dot_constructor_dash_boolean), [`itext7.kernel.pdf-boolean.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_boolean_dot_get_dash_type), [`itext7.kernel.pdf-boolean.get-value`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_boolean_dot_get_dash_value), [`itext7.kernel.pdf-catalog.get-pdf-object`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_catalog_dot_get_dash_pdf_dash_object), [`itext7.kernel.pdf-dictionary.constructor`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_dictionary_dot_constructor), [`itext7.kernel.pdf-dictionary.contains-key`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_dictionary_dot_contains_dash_key), [`itext7.kernel.pdf-dictionary.get`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_dictionary_dot_get), [`itext7.kernel.pdf-dictionary.get-as-direct`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_dictionary_dot_get_dash_as_dash_direct), [`itext7.kernel.pdf-dictionary.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_dictionary_dot_get_dash_type), [`itext7.kernel.pdf-dictionary.key-set`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_dictionary_dot_key_dash_set), [`itext7.kernel.pdf-dictionary.put`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_dictionary_dot_put), [`itext7.kernel.pdf-dictionary.remove`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_dictionary_dot_remove), [`itext7.kernel.pdf-dictionary.size`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_dictionary_dot_size), [`itext7.kernel.pdf-document.constructor-reader-writer`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_constructor_dash_reader_dash_writer), [`itext7.kernel.pdf-document.get-catalog`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_document_dot_get_dash_catalog), [`itext7.kernel.pdf-indirect-reference.equals`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_indirect_dash_reference_dot_equals), [`itext7.kernel.pdf-indirect-reference.get-refers-to`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_indirect_dash_reference_dot_get_dash_refers_dash_to), [`itext7.kernel.pdf-indirect-reference.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_indirect_dash_reference_dot_get_dash_type), [`itext7.kernel.pdf-indirect-reference.hash-code`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_indirect_dash_reference_dot_hash_dash_code), [`itext7.kernel.pdf-name.constructor-string`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_name_dot_constructor_dash_string), [`itext7.kernel.pdf-name.equals`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_name_dot_equals), [`itext7.kernel.pdf-name.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_name_dot_get_dash_type), [`itext7.kernel.pdf-name.get-value`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_name_dot_get_dash_value), [`itext7.kernel.pdf-name.hash-code`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_name_dot_hash_dash_code), [`itext7.kernel.pdf-null.constant-pdf-null`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_null_dot_constant_dash_pdf_dash_null), [`itext7.kernel.pdf-null.constructor`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_null_dot_constructor), [`itext7.kernel.pdf-null.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_null_dot_get_dash_type), [`itext7.kernel.pdf-number.constructor-double`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_number_dot_constructor_dash_double), [`itext7.kernel.pdf-number.constructor-int`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_number_dot_constructor_dash_int), [`itext7.kernel.pdf-number.double-value`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_number_dot_double_dash_value), [`itext7.kernel.pdf-number.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_number_dot_get_dash_type), [`itext7.kernel.pdf-number.int-value`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_number_dot_int_dash_value), [`itext7.kernel.pdf-number.set-value-double`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_number_dot_set_dash_value_dash_double), [`itext7.kernel.pdf-number.set-value-int`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_number_dot_set_dash_value_dash_int), [`itext7.kernel.pdf-object.constant-array`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_constant_dash_array), [`itext7.kernel.pdf-object.constant-boolean`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_constant_dash_boolean), [`itext7.kernel.pdf-object.constant-dictionary`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_constant_dash_dictionary), [`itext7.kernel.pdf-object.constant-indirect-reference`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_constant_dash_indirect_dash_reference), [`itext7.kernel.pdf-object.constant-name`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_constant_dash_name), [`itext7.kernel.pdf-object.constant-null`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_constant_dash_null), [`itext7.kernel.pdf-object.constant-number`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_constant_dash_number), [`itext7.kernel.pdf-object.constant-stream`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_constant_dash_stream), [`itext7.kernel.pdf-object.constant-string`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_constant_dash_string), [`itext7.kernel.pdf-object.get-indirect-reference`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_get_dash_indirect_dash_reference), [`itext7.kernel.pdf-object.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_get_dash_type), [`itext7.kernel.pdf-object.is-array`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_is_dash_array), [`itext7.kernel.pdf-object.is-boolean`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_is_dash_boolean), [`itext7.kernel.pdf-object.is-dictionary`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_is_dash_dictionary), [`itext7.kernel.pdf-object.is-indirect-reference`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_is_dash_indirect_dash_reference), [`itext7.kernel.pdf-object.is-name`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_is_dash_name), [`itext7.kernel.pdf-object.is-null`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_is_dash_null), [`itext7.kernel.pdf-object.is-number`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_is_dash_number), [`itext7.kernel.pdf-object.is-stream`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_is_dash_stream), [`itext7.kernel.pdf-object.is-string`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_object_dot_is_dash_string), [`itext7.kernel.pdf-reader.constructor-input-stream`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_reader_dot_constructor_dash_input_dash_stream), [`itext7.kernel.pdf-stream.constructor-bytes`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_stream_dot_constructor_dash_bytes), [`itext7.kernel.pdf-stream.get-bytes`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_stream_dot_get_dash_bytes), [`itext7.kernel.pdf-stream.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_stream_dot_get_dash_type), [`itext7.kernel.pdf-stream.set-data`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_stream_dot_set_dash_data), [`itext7.kernel.pdf-string.constructor-bytes`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_string_dot_constructor_dash_bytes), [`itext7.kernel.pdf-string.constructor-string`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_string_dot_constructor_dash_string), [`itext7.kernel.pdf-string.get-type`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_string_dot_get_dash_type), [`itext7.kernel.pdf-string.get-value`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_string_dot_get_dash_value), [`itext7.kernel.pdf-string.get-value-bytes`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_string_dot_get_dash_value_dash_bytes), [`itext7.kernel.pdf-writer.constructor-output-stream`](facade-surface.md#facade-surface-itext7_dot_kernel_dot_pdf_dash_writer_dot_constructor_dash_output_dash_stream)
- Preview: none
...
- `facade-values-consumer-contract`: [`pdf-migration-itext7/src/test/java/net/zerocloud/pdf/itext7/consumer/PdfValuesFacadeTest.java`](../../pdf-migration-itext7/src/test/java/net/zerocloud/pdf/itext7/consumer/PdfValuesFacadeTest.java) — Both interfaces reopen equivalent values and mutations; Facade failures retain real Native causes, ownership, bounds, expiry, protected state and unchanged resources.
- `facade-artifact-contract`: [`pdf-migration-itext7/src/test/java/net/zerocloud/pdf/migration/itext7/contract/JarContractIT.java`](../../pdf-migration-itext7/src/test/java/net/zerocloud/pdf/migration/itext7/contract/JarContractIT.java) — Actual Stable and Preview jars expose the frozen types, fields, signatures, generic and exception contracts with Java 8 classes.

Acceptance Evidence:

- `syntax`: `pass` — [`capabilities/evidence/T71-values-syntax.md`](../../capabilities/evidence/T71-values-syntax.md); producer `qpdf@12.4.0` (`external-tool`)
- `standards`: `pass` — [`capabilities/evidence/T71-values-standards.md`](../../capabilities/evidence/T71-values-standards.md); producer `arlington@0.81` (`external-tool`)
- `semantic`: `pass` — [`capabilities/evidence/T71-values-semantic.md`](../../capabilities/evidence/T71-values-semantic.md); producer `folio-pdf-t09@0.1.0` (`project-test`)
- `visual`: `pass` — [`capabilities/evidence/T71-values-visual.md`](../../capabilities/evidence/T71-values-visual.md); producer `pdfium-cli@v0.11.2-pdfium-chromium-7881` (`external-tool`)

Provenance: [`PROVENANCE.md`](../../PROVENANCE.md), record `T09 Foundation values expansion (#71)`.
...
- Limitation: Public-key encryption, FIPS validation, and signature creation or trust validation remain T37 and T38+ scope. T20's cooperative transaction policy applies in-process, and T21 can transport this same password-security contract through its opt-in Hardened Worker.
